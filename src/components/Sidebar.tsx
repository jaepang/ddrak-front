...
const Sidebar = observer(() => {
  ...
  const currentDateChange = (date: Date) => calendar.currentDateChange(date)
  ...
  return (
    <Container>
      <StyledCard>
        ...
        {page.setCalendarMode && <ExternalEvents />}
      </StyledCard>
      <StyledCard>
        {page.setCalendarMode ? page.borrowTimeMode ? <BorrowTimeSlot /> : <SetTimeSlot /> : <UserMenu />}
      </StyledCard>
    </Container>
  )
})
